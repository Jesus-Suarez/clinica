...
@section('titulo') Nuevo Horario @endsection
...
<div class="row">
    <div class="col-lg-12">
        <br><br>
        <h1 class="page-header dropdown-toggle">Crear un nuevo horario</h1><br>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<section class="content">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body bg-info">
            <form role="form" action="{{route('guardaHorario')}}" method="POST">
                {{csrf_field()}}
                <div class="row">
