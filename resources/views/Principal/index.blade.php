...
<head>
  ...
  <!-- =======================================================
  * Template Name: Digital Clinic - v4.0.0
  * Template URL: https://bootstrapmade.com/Digital Clinic-free-medical-bootstrap-theme/
...
<body>
  ...
  <!-- ======= Logo ======= -->
      <h1 class="logo me-auto"><a href="index.html">DigitalClinic</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo me-auto"><img src="{{ asset('img/logo.png" alt="" class="img-fluid') }}"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Planeación Estratégica</a></li>
          <li><a class="nav-link scrollto" href="#about">Video Promocional</a></li>
          <li><a class="nav-link scrollto" href="#services">Video Institucional</a></li>
          <li><a class="nav-link scrollto" href="#departments">Compromiso de la empresa</a></li>
          <li><a class="nav-link scrollto" href="#doctors">Galeria</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to Digital Clinic</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Why Choose Digital Clinic?</h3>
              <p>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Digital Clinic</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          <!-- All the links in the footer should remain intact. -->
          <!-- You can delete the links only if you purchased the pro version. -->
          <!-- Licensing information: https://bootstrapmade.com/license/ -->
          <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/Digital Clinic-free-medical-bootstrap-theme/ -->
